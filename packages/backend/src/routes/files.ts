...
filesRouter.get('/page/*path', async (req, res) => {
  const page = await readPage(joinedPath(req.params.path))
  if (page.type === 'board') {
    res.json({ ...page, board: parseKanban(page.content) })
    return
...
filesRouter.put('/page/*path', async (req, res) => {
...
filesRouter.patch('/page/*path/meta', async (req, res) => {
...
filesRouter.post('/pages', async (req, res) => {
...
filesRouter.patch('/page/*path/move', async (req, res) => {
...
filesRouter.delete('/page/*path', async (req, res) => {
  await deletePage(joinedPath(req.params.path))
  res.json({ ok: true })
})

filesRouter.put('/sections/*path', async (req, res) => {
...
filesRouter.delete('/sections/*path', async (req, res) => {
